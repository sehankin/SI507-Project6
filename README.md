...
First, you should create a database. You can try with an "interim" database if you like, but ultimately, the database for this project should be called **sehankin_507project6** (so mine would be `jczetta_507project6` or Anand's would be `anandpd_507project6`).
